# -*- coding: utf-8 -*-
"""
Created on Fri Jun 15 13:14:39 2018
...
def scrape_facebook_page(page_id, access_token):
    ...
    with open('%s_facebook_posts.csv' % page_id, 'w',newline='', encoding='utf-8') as file:
...
page_id ="write the page ID that you want to scarp"
access_token = "your facebook access token"

if __name__ == '__main__':
  #reading pages id from the excel file
  #df = pandas.read_excel('Pages.xlsx', sheet_name='Fake')
  #for page_id in df['Fake_pages_ID'][:]:
